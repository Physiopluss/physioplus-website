  ...
  return (
    <div className="py-4 min-h-[110vh] flex flex-col justify-around items-center gap-4">
      ...
      <div className="relative flex flex-col gap-4 md:w-1/2 items-center text-center">
        ...
        {/* heading */}
        <Typography variant="h2" className="px-4 sm:px-0 text-5xl sm:text-6xl font-semibold text-black">
          Get the Right <span className="text-green">Physio Care</span> for <span className="text-green">You</span>
        </Typography>
        <Typography variant="h5" className="px-4 sm:px-0 text-base font-medium text-black">
        ...
        {/* decorative images */}
        <img src="/home/HeroIllustratorOne.png" alt="" className="lg:block hidden absolute -bottom-4 -left-48" />
        <img src="/home/HeroIllustratorTwo.png" alt="" className="md:block hidden absolute -bottom-4 -right-44" />
      </div>
