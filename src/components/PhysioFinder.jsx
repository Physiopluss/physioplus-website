...
export default function PhysioFinder() {
	...
	return (
		<div className="mx-auto border border-[#EAEBEC] rounded-2xl p-3 bg-white">
			<h1 className="text-2xl font-semibold text-gray-900 mb-6">Find Physio Now</h1>
			...
			<div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
					...
					<div className="flex items-center justify-left md:justify-start gap-3">
						...
						<div className="flex flex-col relative w-full">
							...
							<div className="relative">
								<select
									value={speciality === " " ? "Select Specialisation" : speciality}
								...
								>
									<option value="Select Specialisation">Select Specialisation</option>
					...
					<div className="flex items-center justify-left md:justify-start gap-3">
                      ...
                      w-8 h-8 object-contain aspect-square"
						...
						<div className="flex flex-col relative w-full">
							...
							<div className="relative">
								<select
									value={serviceType === " " ? "Select Mode" : serviceType}
				...
				<button
					onClick={() => {
						if (location === "" && speciality === "" && serviceType === "") {
