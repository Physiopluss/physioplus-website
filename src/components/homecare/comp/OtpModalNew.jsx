...
import { setOtpModalOpen } from "../../../slices/homecare/newModalSlice";
...
export default function OtpModalNew() {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-lg gap-8 h-full flex flex-col justify-center items-center">
        <div className="flex flex-col gap-1">
          <p className="text-xl font-semibold text-center">Verify OTP</p>
          <p className="text-center text-sm">Sent to your {phone}</p>
        </div>
