      ...
      <div className="md:hidden">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-4">
            ...
            <div className="relative h-fit">
              <div className="w-24 h-24">
                ...
                <img
                  className={`rounded-lg justify-center bg-[#F1F9F4] w-24 h-24 object-cover cursor-pointer ${physio?.subscriptionId?.planId?.planType === 2
              ...
              <div className={`absolute -bottom-3 right-1/2 translate-x-1/2 py-1 px-3 border-white border text-nowrap bg-green rounded-2xl text-xs text-white w-fit flex items-center gap-1 ${physio?.subscriptionId?.planId?.planType === 2
          ...
          <div className="flex justify-between items-center">
            <div className="flex">
              {physio?.subscriptionId?.planId?.planType === 2 && (
                <button
                  type="button"
                  className="text-xs px-3 py-1 rounded-full font-semibold bg-yellow-100 text-yellow-900  cursor-default"
                >
                  Premium
                </button>
              )}
          ...
          <div className="flex gap-4">
            ...
            <div className="relative h-fit">
              <div className="w-28 h-28">
                ...
                <img
                  className={`rounded-lg justify-center bg-[#F1F9F4] w-28 h-28 object-cover cursor-pointer border-2 ${physio?.subscriptionId?.planId?.planType === 2
                    ? "shadow-lg shadow-[#e7d234]"
                    : " shadow-lg shadow-green"
                    } ${!imageLoaded ? "hidden" : "block"}`}
                  src={physio.profileImage}
              ...
              {/* Work Experience Tag */}
              <div className={`absolute -bottom-5 right-1/2 translate-x-1/2 py-1 px-4 border-white border text-nowrap rounded-2xl text-sm w-fit flex items-center gap-1.5 ${physio?.subscriptionId?.planId?.planType === 2
                ? "bg-yellow-100 text-yellow-900"
                : "bg-green  text-white"
