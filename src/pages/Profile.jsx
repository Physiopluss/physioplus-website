      ...
      <div className="mx-4 md:mx-8 lg:mx-16 -mt-12 bg-white pb-8 rounded-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Manage your booked consultation
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Logout your profile as a Patient
              </p>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex-1 p-8 bg-white rounded-r-2xl">
            <div className="block md:hidden text-xl font-semibold mb-4">
              My Profile
            </div>
              ...
              <div className="flex justify-between items-center mb-12">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    <button
                      className={
                        "absolute bottom-0 right-0 bg-white p-1 rounded-full border shadow-sm" +
                        (!editMode && " hidden")
                      }
                    >
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <input
                    ...
                    className={
                      "w-2/3 p-2 border rounded-lg bg-gray-50" +
                      (!editMode && " hidden")
                    }
                  />
                </div>
