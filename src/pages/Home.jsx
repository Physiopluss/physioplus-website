      ...
      <div className="max-w-[100vw]">
        ...
        <section className="bg-[#FFFDF8] pt-12 md:pt-[108px] pb-9 md:pb-24 px-4 sm:px-12 lg:px-[120px] ">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <SpecializationCard
              ...
              description={
                "Visit our clinic for professional in-house treatment"
              }
              onclickFn={() => {
          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-4 text-white items-center">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <p className="text-base text-left my-0 lg:pl-0 lg:pr-2">
                Choose clinic or home care—both options offer expert,
                personalized physiotherapy for your convenience and comfort
              </p>
            </div>
            <div className="hidden md:block">
              ...
              >
                Download our App <FaApple className="w-5 h-5" />{" "}
          ...
          <div className=" lg:hidden max-w-sm mx-auto mt-8">
            <div className="bg-emerald-600 rounded-2xl p-6 text-center text-white shadow-md border border-emerald-600">
              ...
              <p className="text-sm mb-6">
                Unlock exclusive features, seamless booking, and expert
                physiotherapy care at your fingertips. Stay on track, book
                sessions effortlessly, and take control of your recovery all in
                one app.
              </p>
              {/* Centered Button */}
        ...
        <section className="bg-[#FFFCF0] pt-12 md:pt-[108px] pb-11 md:pb-24 px-4 sm:px-12 lg:px-[120px]">
          <HomeTitleComponent
            ...
            description={
              "Experience seamless recovery with cashless physiotherapy, designed for convenience and ease"
            }
          />
          <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-8 xl:gap-14">
            ...
            <TextContainer
              ...
              list={
                <>
                  <li className="flex items-center gap-2 md:gap-4">
                    <img src="/success.png" className="w-4 h-4" />
              ...
              lastText={
                "Click below to learn more about how your insurance can cover your physiotherapy sessions"
              }
        ...
        <section
          className="bg-[#F5FAF7] pt-12 md:pt-[108px] pb-11 md:pb-24 px-4 sm:px-12 lg:px-[120px]"
          style={{
        ...
        >
          ...
          <div className="hidden lg:flex  flex-col lg:flex-row justify-center items-center gap-10 px-6 py-12 bg-transparent">
            ...
            {/* Middle Section */}
            <PhonePreview
              screenshotSrc="home/screenshot-long.png "
              overlaySrc="home/PhonePopUp.png"
        ...
        <div className="flex flex-col md:flex-col gap-4 pt-12 md:pt-[108px] pb-11 md:pb-24 px-4 sm:px-12 lg:px-[120px]   items-center ">
          <div className="w-full flex flex-col items-center text-center gap-6">
            ...
            <p
              className="mt-4 sm:mt-6 w-full text-center "
              style={{ wordSpacing: "0.2rem" }}
            >
              Discover our locations closest to you and experience our services
              firsthand. Whether you're around the corner or a few miles away,
              we're just a step away from making your day better.
            </p>
