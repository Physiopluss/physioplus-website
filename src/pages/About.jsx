    ...
    <div className="flex flex-col bg-white mx-auto relative">
      ...
      <div className="relative inset-0 flex min-h-[calc(100vh-100px)] w-full py-4 flex-col gap-8 md:gap-0 md:flex-row items-center justify-evenly bg-[#FFFDF5] overflow-hidden">
        <div className="w-[70%] md:w-[40%] flex flex-col gap-4 lg:gap-8 z-10 ">
          ...
          >
            Reducing Pain and transforming recovery with integrated{" "}
            <span className="text-[#008037]">Physio Care</span>
          </Typography>

          <Typography variant="h5" className="text-base font-normal text-black">
            At Physioplus experience faster recovery and lasting pain relief
            with Integrated Physio Care – combining expert physiotherapy and
            advanced treatments to restore mobility, strength, and confidence
          </Typography>

          <Button
            onClick={() => navigate("/physios")}
            className={
              "rounded-full font-semibold text-base w-fit bg-green text-white px-8 py-2"
            }
          >
            Reduce Pain Now
          </Button>
        ...
        <img
          src="about-group.png"
          alt="image 2"
          className="w-[75%] md:w-[45%] z-10 bg-[url('/about-group.png')] bg-no-repeat"
        />
      </div>
      ...
      <section className="w-full pt-12 md:pt-[108px] pb-11 md:pb-24 px-4 sm:px-12 lg:px-[120px]">
        ...
        <p className="relative text-center text-base font-normal">
          ...
          />
          Our journey began with a personal experience. Our founder, Jaswant
          Singh, witnessed his friend Hitesh suffered an ACL tear while playing
          football. Seeing the challenges Hitesh faced during his recovery,
          Jaswant realized the critical role of skilled sports physiotherapists
          in preventing and treating injuries.
          <br />
          <br />
          Inspired by this experience, we set out to create an accessible
          platform connecting athletes and individuals with qualified
          physiotherapists. Our mission is to educate parents, coaches, and the
          general public about the importance of preventive care and
          rehabilitation in sports and everyday life. By providing a convenient
          way to find the right physiotherapist, we aim to support individuals
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center mt-4">
          <Card className="mt-6 mb-2 bg-[#E6F4EC]">
            <CardBody>
              <img src="/aboutImg/mission.png" alt="" />
              <Typography
                variant="h5"
              ...
              >
                To become the leading physiotherapy service provider across
                India by delivering exceptional care, personalized treatment
                plans, and innovative solutions that improve the quality of life
                for our clients. We are dedicated to building a healthier nation
                through accessible, professional, and result-oriented
                physiotherapy services, ensuring our clients achieve optimal
                physical well-being.
              </Typography>
            </CardBody>
          </Card>
          <Card className="mt-6 mb-2 bg-[#E6F4EC]">
            <CardBody>
              ...
              <Typography
                ...
                className="mt-4 text-base font-normal"
              >
                At PhysioPlus Healthcare, our vision To ensure that no
                sportsperson or individual is ever forced to leave their career
                or live in worry due to physical limitations. We strive to
                empower people with the highest quality physiotherapy services,
                helping them overcome injuries and challenges, so they can
                continue pursuing their passions and living their lives to the
                fullest patients
              </Typography>
            </CardBody>
          </Card>
      ...
      <section className="pt-12 md:pt-[108px] pb-11 md:pb-24 px-4 sm:px-12 lg:px-[120px] bg-[#FFFDF5]">
        <div className="bg-white">
          <div className="bg-[#E6F2EB] py-8 rounded-lg grid grid-cols-1 divide-y-2 md:divide-y-0 gap-4 md:gap-0 md:grid-cols-3 sm:divide-x-2 divide-white ">
            <ServiceCard number={"2022"} text={"Founded Year"} />
            <ServiceCard number={"2700+"} text={"Physio Associated"} />
            <ServiceCard number={"3000+"} text={"Patient Treated"} />
          </div>
        </div>
      ...
      <div className="pt-12 md:pt-[108px] pb-11 md:pb-24 px-4 sm:px-12 lg:px-[120px] bg-[#FFFDED]">
        <h6 className="sm:text-4xl text-start text-3xl font-bold w-full mb-8">
          See What's Our Patient Says
        </h6>
