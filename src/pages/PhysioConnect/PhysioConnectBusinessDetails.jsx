...
const PhysioConnectBusinessDetails = () => {
  ...
  useEffect(() => {
    ReactGA.send({
      ...
      title: "Physio Connect Work Experience",
    });
  }, []);
  ...
  const [hasUserChangedClinicPincode, setHasUserChangedClinicPincode] =
    useState(false);
  const [hasUserChangedHomePincode, setHasUserChangedHomePincode] =
    useState(false);
  ...
  useEffect(() => {
    const fetchCityState = async () => {
      if (
        hasUserChangedClinicPincode &&
        formik.values.clinicPincode.length === 6
      ) {
        try {
          ...
          const city =
            components.find((d) => d.types.includes("locality"))?.long_name ||
            "";
          const state =
            components.find((d) =>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="border-none placeholder:text-gray-500 placeholder:opacity-100 bg-white ring-1 ring-[#A9ABB2] focus:ring-2 focus:ring-black"
                    />
                    {formik.touched.clinicCharges &&
                      formik.errors.clinicCharges && (
                        <p className="text-red-500">
                          {formik.errors.clinicCharges}
                        </p>
                      )}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="border-none placeholder:text-gray-500 placeholder:opacity-100 bg-white ring-1 ring-[#A9ABB2] focus:ring-2 focus:ring-black"
                    />
                    {formik.touched.clinicDuration &&
                      formik.errors.clinicDuration && (
                        <p className="text-red-500">
                          {formik.errors.clinicDuration}
                        </p>
                      )}
              ...
              <div>
                ...
                <div className="">
                  <div className="space-y-2 mb-3">
                    ...
                    {formik.touched.homePincode &&
                      formik.errors.homePincode && (
                        <p className="text-red-500">
                          {formik.errors.homePincode}
                        </p>
                      )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="border-none placeholder:text-gray-500 placeholder:opacity-100 bg-white ring-1 ring-[#A9ABB2] focus:ring-2 focus:ring-black"
                      />
                      {formik.touched.homeCharges &&
                        formik.errors.homeCharges && (
                          <p className="text-red-500">
                            {formik.errors.homeCharges}
                          </p>
                        )}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="border-none placeholder:text-gray-500 placeholder:opacity-100 bg-white ring-1 ring-[#A9ABB2] focus:ring-2 focus:ring-black"
                      />
                      {formik.touched.homeDuration &&
                        formik.errors.homeDuration && (
                          <p className="text-red-500">
                            {formik.errors.homeDuration}
                          </p>
                        )}
