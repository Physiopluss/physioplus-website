...
const PhysioConnectPayment = () => {
  ...
  useEffect(() => {
    coupon &&
      couponResponse &&
      couponResponse.couponName == coupon &&
      SetDiscountedPrice(couponResponse.discount);
    ...
    <>
      <div className="flex flex-col md:flex-row gap-4 bg-white  py-4 justify-center  md:px-8 lg:px-16">
              ...
              {(() => {
                ...
                const couponDiscount =
                  couponResponse?.couponType === 0
                    ? discountedPrice || 0
                    : Math.round(
                        ((discountedPrice || 0) * baseForCoupon) / 100
                      );
            ...
            <div className="flex items-start space-x-2">
              ...
              <p className="text-sm">
                ...
                <span
                  ...
                  onClick={() =>
                    window.open("/physio-terms&condition", "_blank")
                  }
                >
                  Terms of Service
                </span>{" "}
        ...
        <SuccessModal
          ...
          btnOne={"Download Our App & login"}
          btnOneFunction={() => {
            // Optional: Close modal or show feedback
            dispatch(setSuccessModalOpen());

            // Redirect directly to Google Play Store URL
            window.open(
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Increase your visibility and connect with more clients,
                    offering services. Your practice grows steadily
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Maximize your earning potential by taking on additional
                    clients at your convenience, allowing flexible
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    In today's digital world, your online presence matters just
                    as much as your in-clinic expertise
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white px-3 py-1 shadow border-t z-50 text-xs">
            ...
            <div className="flex items-center justify-between ">
              ...
              <p className="font-semibold">
                ₹ {amoutToPay ? amoutToPay.toLocaleString() : "0"}
              </p>
            </div>
            <hr className=" border-gray-200" />
