...
const PhysioConnectPersonalForm = () => {
  ...
  useEffect(() => {
    ReactGA.send({
      ...
      title: "Physio Connect Personal Form",
    });
  }, []);
  ...
  const autofillTexts = {
    Passionate:
      "I am dedicated to guiding patients on their journey to recovery with energy, empathy, and unwavering commitment.",
    Experienced:
    ...
    Compassionate:
      "I understand the challenges of recovery and approach each patient with care, patience, and empathy to make their healing journey as comfortable as possible.",
    Innovative:
      "I constantly explore new techniques and technologies to enhance treatments, ensuring my patients receive cutting-edge care that's both effective and engaging.",
    Trustworthy:
      "Building strong, honest relationships with my patients is my priority, creating a safe space where they feel comfortable sharing their concerns and goals.",
    Motivated:
      "I am driven to help patients achieve their best possible outcomes, encouraging them every step of the way to stay positive and committed to their recovery.",
    Approachable:
      "I maintain an open and friendly environment where patients feel heard, understood, and supported.",
  };
  ...
  useEffect(() => {
    if (oldPhysioData) {
      formik.setValues({
        ...
        gender:
          oldPhysioData.gender != null ? oldPhysioData.gender.toString() : "",
